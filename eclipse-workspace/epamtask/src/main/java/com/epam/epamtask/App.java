...
public class App 
{
	static void name_sort(Vector<Gifts> child1,Vector<Gifts> child2)
	{
	...
	static void quantity_sort(Vector<Gifts> child1,Vector<Gifts> child2)
	{
		Vector<Chocolate> v=new Vector<Chocolate>();
		for(Gifts g : child1)
		{
	...
	static void weight_sort(Vector<Gifts> child1,Vector<Gifts> child2)
	{
		Vector<Chocolate> v=new Vector<Chocolate>();
		for(Gifts g : child1)
		{
	...
	static void search(String cn,Vector<Gifts> child1,Vector<Gifts> child2)
	{
    ...
    {
    	Vector<Gifts> child1=new Vector<Gifts>();
    	Vector<Gifts> child2=new Vector<Gifts>();
    	child1.add(new Chocolate("Dairy milk",2,15));
    	child1.add(new Chocolate("kit kat",10,2));
    	child1.add(new Chocolate("Milky bar",5,20));
    	...
    	child1.add(new Candy("kacha mango",20,2));
    	child1.add(new Candy("Mangobite",10,2));
    	child1.add(new Candy("coffee bite",5,2));
    	
    	child2.add(new Chocolate("kit kat",10,20));
    	child2.add(new Chocolate("Dairy milk silk",1,100));
    	child2.add(new Chocolate("perk",1,200));
    	child2.add(new Sweets("Kaju barfi",2,500));
    	child2.add(new Sweets("kala jamun",1,50));
    	child2.add(new Candy("orange candy",20,2));
    	child2.add(new Candy("snickers",10,2));
    	...
    	{
	    	System.out.println("Enter the candy's name to search in gift Boxes : ");
	    	String cn=br.readLine();
	    	search(cn,child1,child2);
	    	System.out.println("Do you want to continue searching( type yes/no)");
	    	s=br.readLine();
    	}
    }
}